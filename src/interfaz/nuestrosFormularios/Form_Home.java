...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initCardData() {
        ...
        card1.setData(new ModelCard("Nuevos Clientes", 100, 20, icon1));
        //Icon icon2 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.MONETIZATION_ON, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        //card2.setData(new ModelCard("", 2000, 60, icon2));
        Icon icon3 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.SHOPPING_BASKET, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card3.setData(new ModelCard("Ventas Mensuales", VentasMensuales(), 80, icon3));
        //Icon icon4 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.BUSINESS_CENTER, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        //card4.setData(new ModelCard("", 550, 95, icon4));//NOMBRE, CANTIDAD, PORCENTAJE E ICONO
    }
    ...
    private void initComponents() {
        ...
        card1 = new interfaz.raven.component.Card();
        jLabel1 = new javax.swing.JLabel();
        card3 = new interfaz.raven.component.Card();
        jPanel1 = new javax.swing.JPanel();
        jLabel2 = new javax.swing.JLabel();
        jLabel4 = new javax.swing.JLabel();
        jScrollPane2 = new javax.swing.JScrollPane();
        table2 = new interfaz.raven.swing.table.Table();
        ...
        jLabel5.setText("Productos más vendidos");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(card1, javax.swing.GroupLayout.PREFERRED_SIZE, 450, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(card3, javax.swing.GroupLayout.PREFERRED_SIZE, 450, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private interfaz.raven.component.Card card1;
    private interfaz.raven.component.Card card3;
    ...
    private interfaz.raven.swing.table.Table table2;
