...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initTableData() {
        ...
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/imagenes/profile.jpg")), "Jonh", "Male", "Java", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/imagenes/profile1.jpg")), "Dara", "Male", "C++", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/imagenes/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/imagenes/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/imagenes/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/imagenes/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/imagenes/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
    ...
    private void initComponents() {
        ...
        noticeBoard.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                noticeBoardMouseClicked(evt);
            }
        });
    ...
    private void noticeBoardMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_noticeBoardMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_noticeBoardMouseClicked
