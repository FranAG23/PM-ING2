...
public class Menu extends javax.swing.JPanel {
    ...
    private void initData() {
        listMenu.addItem(new Model_Menu("1", "Ventas", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("2", "Stock", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("3", "Finanzas", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/Logo Malaika 2.png"))); // NOI18N
        ...
        listMenu.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(this);
        this.setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(listMenu, javax.swing.GroupLayout.DEFAULT_SIZE, 313, Short.MAX_VALUE)
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#cc9f9a"), 0, getHeight(), Color.decode("#cc9f9a"));
        g2.setPaint(g);
